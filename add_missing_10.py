#!/usr/bin/env python3
"""
Fügt die letzten 10 wichtigsten Gerichte hinzu
"""
...
async def add_missing_items():
    ...
    print("🎯 LETZTEN 10 WICHTIGSTEN GERICHTE")
    print("=" * 50)
    ...
    try:
        ...
        missing_items = [
            ...
            },
            {
                ...
                "allergens": "Gluten, Milch, Konservierungsstoff",
            ...
            },
            {
                ...
                "category": "Kroketten",
                "origin": "Spanien",
                "allergens": "Gluten, Milch, Ei, Konservierungsstoff",
                "additives": "Konservierungsstoff: Natriumnitrit (E250)",
                "preparation_method": "Frittiert",
            ...
            },
            {
                ...
                "origin": "Fusion-Küche",
                "allergens": "Nüsse, Konservierungsstoff",
                "additives": "Konservierungsstoff: Natriumnitrit (E250)",
            ...
            },
            {
                ...
                "allergens": "Kann Spuren von Milch enthalten, Konservierungsstoff",
        ...
        print(f"✅ {count} wichtige Gerichte hinzugefügt!")
        ...
        print(f"🎉 KOMPLETT! {total_detailed[0]} von {total_items[0]} Gerichten haben vollständige Details!")
