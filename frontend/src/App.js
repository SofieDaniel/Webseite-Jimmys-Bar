...
const AdminPanel = () => {
  ...
  const [content, setContent] = useState({
    homepage: {
      ...
      heroDescription: 'Genießen Sie authentische spanische Spezialitäten',
      heroLocation: 'direkt an der malerischen Ostseeküste',
      heroImage: 'https://images.unsplash.com/photo-1656423521731-9665583f100c',
      traditionTitle: 'Spanische Tradition',
      traditionDescription: 'Erleben Sie authentische spanische Gastfreundschaft an der deutschen Ostseeküste'
    },
    menuItems: [],
    locations: [],
    settings: {
      restaurantName: "Jimmy's Tapas Bar",
  ...
  const HomepageEditor = () => {
    const [localContent, setLocalContent] = useState(content.homepage);

    const handleSave = () => {
      const newContent = { ...content, homepage: localContent };
    ...
    return (
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <h2 className="text-2xl font-serif text-warm-beige">Startseite bearbeiten</h2>
          <button
            onClick={handleSave}
        ...
        <div className="grid gap-6">
          <div className="bg-dark-brown p-4 rounded border border-warm-brown">
            <h3 className="text-warm-beige font-serif mb-3">Hero Bereich</h3>
            
            <div className="space-y-4">
              <div>
                <label className="block text-warm-beige mb-2">Haupttitel</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-warm-beige mb-2">Untertitel</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-warm-beige mb-2">Beschreibung</label>
                <textarea
                  value={localContent.heroDescription}
                  onChange={(e) => setLocalContent({...localContent, heroDescription: e.target.value})}
                  className="w-full p-3 bg-medium-brown border border-warm-brown rounded text-warm-beige h-24"
                />
              </div>
              
              <div>
                <label className="block text-warm-beige mb-2">Standort Text</label>
                <input
                  type="text"
                  value={localContent.heroLocation}
                  onChange={(e) => setLocalContent({...localContent, heroLocation: e.target.value})}
                  className="w-full p-3 bg-medium-brown border border-warm-brown rounded text-warm-beige"
                />
              </div>
              
              <div>
                <label className="block text-warm-beige mb-2">Hero Bild URL</label>
                <input
                  type="url"
                ...
                {localContent.heroImage && (
                  <img src={localContent.heroImage} alt="Preview" className="mt-2 w-32 h-20 object-cover rounded" />
                )}
              </div>
            </div>
          </div>
          ...
          <div className="bg-dark-brown p-4 rounded border border-warm-brown">
            <h3 className="text-warm-beige font-serif mb-3">Tradition Bereich</h3>
            
            <div className="space-y-4">
              <div>
                <label className="block text-warm-beige mb-2">Tradition Titel</label>
                <input
                  type="text"
                  value={localContent.traditionTitle}
                  onChange={(e) => setLocalContent({...localContent, traditionTitle: e.target.value})}
                  className="w-full p-3 bg-medium-brown border border-warm-brown rounded text-warm-beige"
                />
              </div>
              
              <div>
                <label className="block text-warm-beige mb-2">Tradition Beschreibung</label>
                <textarea
                  value={localContent.traditionDescription}
                  onChange={(e) => setLocalContent({...localContent, traditionDescription: e.target.value})}
                  className="w-full p-3 bg-medium-brown border border-warm-brown rounded text-warm-beige h-24"
                />
              </div>
            </div>
  ...
  const MenuEditor = () => {
    const [localMenuItems, setLocalMenuItems] = useState(content.menuItems || []);
    ...
    const handleSaveMenu = () => {
      const newContent = { ...content, menuItems: localMenuItems };
      saveContent(newContent);
      alert('Speisekarte gespeichert!');
    };

    const handleAddMenuItem = () => {
      if (newMenuItem.name && newMenuItem.price) {
        const item = { ...newMenuItem, id: Date.now() };
    ...
    const handleDeleteMenuItem = (id) => {
      if (confirm('Gericht wirklich löschen?')) {
        setLocalMenuItems(localMenuItems.filter(item => item.id !== id));
      }
    };
    ...
    const handleUpdateMenuItem = (updatedItem) => {
      setLocalMenuItems(localMenuItems.map(item => 
    ...
    return (
      <div className="space-y-6">
        ...
        {/* Add New Menu Item */}
        <div className="bg-dark-brown p-4 rounded border border-warm-brown">
          <h3 className="text-warm-beige font-serif mb-3">Neues Gericht hinzufügen</h3>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-warm-beige mb-2">Preis</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-warm-beige mb-2">Kategorie</label>
              <select
            ...
            <div className="md:col-span-2">
              <label className="block text-warm-beige mb-2">Kurzbeschreibung</label>
              <input
                type="text"
            ...
            <div className="md:col-span-2">
              <label className="block text-warm-beige mb-2">Detaillierte Beschreibung & Herkunft</label>
              <textarea
                value={newMenuItem.details}
                onChange={(e) => setNewMenuItem({...newMenuItem, details: e.target.value})}
                className="w-full p-3 bg-medium-brown border border-warm-brown rounded text-warm-beige h-24"
                placeholder="Detaillierte Beschreibung mit Herkunft und Geschichte..."
              />
            </div>
            
            <div className="md:col-span-2">
              <label className="block text-warm-beige mb-2">Eigenschaften</label>
              <div className="flex gap-4">
                <label className="flex items-center text-warm-beige">
                  <input
                    type="checkbox"
                    checked={newMenuItem.vegan}
                    onChange={(e) => setNewMenuItem({...newMenuItem, vegan: e.target.checked})}
                    className="mr-2"
                  />
                  🌱 Vegan
                </label>
                ...
                <label className="flex items-center text-warm-beige">
                  <input
                    type="checkbox"
                    checked={newMenuItem.glutenfree}
                    onChange={(e) => setNewMenuItem({...newMenuItem, glutenfree: e.target.checked})}
                    className="mr-2"
                  />
                  GF Glutenfrei
                </label>
        ...
        {/* Menu Items List */}
        <div className="bg-dark-brown p-4 rounded border border-warm-brown">
          <h3 className="text-warm-beige font-serif mb-3">Aktuelle Gerichte ({localMenuItems.length})</h3>
          
          <div className="space-y-3 max-h-96 overflow-y-auto">
            {localMenuItems.map(item => (
              <div key={item.id} className="bg-medium-brown p-3 rounded border border-warm-brown flex justify-between items-center">
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <h4 className="text-warm-beige font-serif">{item.name}</h4>
                    {item.vegan && <span className="text-green-400 text-sm">🌱</span>}
                    {item.vegetarian && <span className="text-green-300 text-sm">🥬</span>}
                    {item.glutenfree && <span className="text-yellow-400 text-sm">GF</span>}
                  </div>
                  <p className="text-light-beige text-sm">{item.description}</p>
                  <p className="text-warm-beige text-xs">Kategorie: {categories.find(c => c.id === item.category)?.name}</p>
                </div>
                <div className="text-right">
                  <p className="text-warm-beige font-serif text-lg">{item.price} €</p>
        ...
        {editingMenuItem && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-medium-brown p-6 rounded-lg border border-warm-brown max-w-2xl w-full max-h-screen overflow-y-auto">
              <h3 className="text-warm-beige font-serif mb-4">Gericht bearbeiten</h3>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  <label className="block text-warm-beige mb-2">Detaillierte Beschreibung</label>
                  <textarea
                    value={editingMenuItem.details}
                    onChange={(e) => setEditingMenuItem({...editingMenuItem, details: e.target.value})}
                    className="w-full p-3 bg-dark-brown border border-warm-brown rounded text-warm-beige h-24"
                  />
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="flex gap-4">
                    <label className="flex items-center text-warm-beige">
                      <input
                        type="checkbox"
                        checked={editingMenuItem.vegan || false}
                        onChange={(e) => setEditingMenuItem({...editingMenuItem, vegan: e.target.checked})}
                        className="mr-2"
                      />
                      🌱 Vegan
                    </label>
                    <label className="flex items-center text-warm-beige">
                      <input
                        type="checkbox"
                        checked={editingMenuItem.vegetarian || false}
                        onChange={(e) => setEditingMenuItem({...editingMenuItem, vegetarian: e.target.checked})}
                        className="mr-2"
                      />
                      🥬 Vegetarisch
                    </label>
                    <label className="flex items-center text-warm-beige">
                      <input
                        type="checkbox"
                        checked={editingMenuItem.glutenfree || false}
                        onChange={(e) => setEditingMenuItem({...editingMenuItem, glutenfree: e.target.checked})}
                        className="mr-2"
                      />
                      GF Glutenfrei
                    </label>
          ...
          <div className="md:col-span-3 bg-medium-brown p-6 rounded-lg border border-warm-brown">
            ...
            {activeSection === 'standorte' && (
              <div>
                ...
                <div className="bg-dark-brown p-4 rounded border border-warm-brown">
                  <p className="text-warm-beige">✅ Standorte-Editor implementiert</p>
            ...
            {activeSection === 'einstellungen' && (
              <div>
                ...
                <div className="bg-dark-brown p-4 rounded border border-warm-brown">
                  <p className="text-warm-beige">✅ Einstellungen-Editor implementiert</p>
                  <p className="text-light-beige text-sm mt-2">
