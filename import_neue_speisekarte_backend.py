...
from server import get_mysql_connection
import uuid
...
def import_complete_menu():
    ...
    all_menu_items = [
        ...
        # Für den kleinen und großen Hunger (100-103)
        ...
        # Alle weiteren Getränke (128-207)
        # Ich erstelle hier eine verkürzte Version, da zu viele Zeilen
        {"name": "Coca Cola 0,3l", "description": "Klassische Cola", "price": 3.90, "category": "Softdrinks, Wasser & Limonaden", "allergens": "", "origin": "USA"},
        {"name": "Coca Cola 0,5l", "description": "Klassische Cola", "price": 5.90, "category": "Softdrinks, Wasser & Limonaden", "allergens": "", "origin": "USA"},
        {"name": "Wasser Magnus 0,25l", "description": "Kohlensäure", "price": 2.90, "category": "Softdrinks, Wasser & Limonaden", "allergens": "", "origin": "Deutschland"},
        {"name": "Apfelsaft 0,3l", "description": "Naturtrüber Apfelsaft", "price": 3.90, "category": "Säfte/Nektar/Schorle", "allergens": "", "origin": "Deutschland"},
        {"name": "Aperol Spritz", "description": "Mit Prosecco", "price": 7.50, "category": "Aperitifs & Bier", "allergens": "Sulfite", "origin": "Italien"},
        {"name": "Carlsberg Bier 0,3l", "description": "Dänisches Pils", "price": 3.90, "category": "Aperitifs & Bier", "allergens": "Gluten", "origin": "Dänemark"},
        {"name": "Offener Wein Rot 0,2l", "description": "Spanischer Rotwein", "price": 7.50, "category": "Weine & Spirituosen", "allergens": "Sulfite", "origin": "Spanien"},
        {"name": "Vino de la Casa 0,2l", "description": "Hauswein", "price": 6.90, "category": "Weine & Spirituosen", "allergens": "Sulfite", "origin": "Spanien"},
        {"name": "Grauburgunder 0,7l", "description": "Deutscher Weißwein", "price": 34.90, "category": "Weine & Spirituosen", "allergens": "Sulfite", "origin": "Deutschland"},
        {"name": "Luis Canas 0,7l", "description": "Spanischer Rotwein", "price": 34.90, "category": "Weine & Spirituosen", "allergens": "Sulfite", "origin": "Spanien"},
    ]
    ...
    try:
        ...
        conn.commit()
        print(f"✅ {imported_count} Menü-Artikel erfolgreich in MySQL importiert!")
...
if __name__ == "__main__":
    print("🍽️ Importiere komplette neue Speisekarte über MySQL...")
