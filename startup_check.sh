...
ueber_uns_test=$(curl -s https://222aca19-e083-4dd5-8413-c5d602eabf32.preview.emergentagent.com/api/cms/about 2>/dev/null || echo "ERROR")
...
delivery_test=$(curl -s https://222aca19-e083-4dd5-8413-c5d602eabf32.preview.emergentagent.com/api/delivery/info 2>/dev/null || echo "ERROR")
...
standorte_test=$(curl -s https://222aca19-e083-4dd5-8413-c5d602eabf32.preview.emergentagent.com/api/cms/standorte-enhanced 2>/dev/null || echo "ERROR")
...
kontakt_test=$(curl -s https://222aca19-e083-4dd5-8413-c5d602eabf32.preview.emergentagent.com/api/cms/kontakt-page 2>/dev/null || echo "ERROR")
