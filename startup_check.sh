...
ueber_uns_test=$(curl -s https://ab448e3c-ccb5-44e7-ae1f-ce20c1169429.preview.emergentagent.com/api/cms/about 2>/dev/null || echo "ERROR")
...
delivery_test=$(curl -s https://ab448e3c-ccb5-44e7-ae1f-ce20c1169429.preview.emergentagent.com/api/delivery/info 2>/dev/null || echo "ERROR")
...
standorte_test=$(curl -s https://ab448e3c-ccb5-44e7-ae1f-ce20c1169429.preview.emergentagent.com/api/cms/standorte-enhanced 2>/dev/null || echo "ERROR")
...
kontakt_test=$(curl -s https://ab448e3c-ccb5-44e7-ae1f-ce20c1169429.preview.emergentagent.com/api/cms/kontakt-page 2>/dev/null || echo "ERROR")
